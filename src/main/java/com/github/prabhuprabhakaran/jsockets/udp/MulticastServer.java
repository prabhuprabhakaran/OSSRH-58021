...
public class MulticastServer {
    ...
    private Collection<MulticastServer.Listener> listeners = new LinkedList<MulticastServer.Listener>();
    private MulticastServer.Event event = new MulticastServer.Event(this);
    private PropertyChangeSupport propSupport = new PropertyChangeSupport(this);
    private final MulticastServer This = this;
    ...
    public synchronized void start() {
        if (this.currentState == MulticastServer.State.STOPPED) {
            ...
            Runnable run = new Runnable() {
                ...
                public void run() {
                    runServer();
                    ioThread = null;
                    setState(MulticastServer.State.STOPPED);
                }
            };
            ...
            setState(MulticastServer.State.STARTING);
            this.ioThread.start();
        }
    }

    public synchronized void stop() {
        if (this.currentState == MulticastServer.State.STARTED) {
            setState(MulticastServer.State.STOPPING);
    ...
    public synchronized void addUdpServerListener(MulticastServer.Listener l) {
        listeners.add(l);
    }

    public synchronized void removeUdpServerListener(MulticastServer.Listener l) {
        listeners.remove(l);
    }
    ...
    public static class Event extends java.util.EventObject {
        ...
        public MulticastServer getUdpServer() {
